package com.hgnuacm.common.utils;
...
public class MailUtils {// 邮件协议
    ...
    // 发件人邮箱地址
    private static final String emailAccount = "3104044743@qq.com"; // 这个是企业邮箱
    // 发件人邮箱授权码
    private static final String emailPassword = "dilbtwolmkikdgjh";
    ...
    public static boolean sendEmail(Set<String> emails, String title, String content) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress(emailAccount, "大学生迎新平台", "UTF-8"));
            ...
            System.out.println("发送邮件失败,系统错误！");
            return false;
        }
